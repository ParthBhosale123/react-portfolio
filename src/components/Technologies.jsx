    ...
    <section id="skills" className="pt-5">
      <div className="border-b border-neutral-800 pb-24">
        ...
        >
          ...
          {[
            {
              icon: <FaJava className="text-7xl text-blue-400" />,
              label: "Java",
              duration: 2,
            },
            {
            ...
            {
              icon: <FaJs className="text-7xl text-yellow-500" />,
              label: "JavaScript",
              duration: 3.5,
            },
            {
            ...
            {
              icon: <SiTailwindcss className="text-7xl text-blue-300" />,
              label: "Tailwind CSS",
              duration: 4.5,
            },
            {
            ...
            {
              icon: <FaGitAlt className="text-7xl text-orange-400" />,
              label: "Git",
              duration: 5.5,
            },
            {
